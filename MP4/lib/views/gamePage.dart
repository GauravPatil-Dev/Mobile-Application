...
class _GameViewPageState extends State<GameViewPage> {
  ...
  Widget getGridIcon(String position) {
    ...
    if (gameData!.sunk.contains(position)) {
      icons.add(Icon(Icons.local_fire_department_outlined, color: Colors.red));
    }

    if (gameData!.ships.contains(position)) {
      icons.add(
          Icon(Icons.directions_boat_filled_outlined, color: Colors.yellow));
    }

    if (gameData!.shots.contains(position)) {
      icons.add(Icon(Icons.cancel, color: Colors.grey));
    }

    if (gameData!.wrecks.contains(position)) {
      icons.add(Icon(Icons.bubble_chart_outlined, color: Colors.blue));
    }
