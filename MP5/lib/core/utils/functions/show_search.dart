...
Future<void> showSearchBar(
    BuildContext context, HomeRepoImpl homeRepoImpl) async {
  await showSearch(
    context: context,
    delegate: CustomSearchDelegate(homeRepoImpl),
  );
}

class CustomSearchDelegate extends SearchDelegate {
  final HomeRepoImpl homeRepoImpl;
  CustomSearchDelegate(this.homeRepoImpl);
  ...
  Widget buildResults(BuildContext context) {
    return BlocProvider(
      create: (context) => SearchCubit(homeRepoImpl)..search(query),
